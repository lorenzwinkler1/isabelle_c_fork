...
% \input{session}
\newpage
\inputif{1/document/Clean.tex}
\inputif{2/document/Quicksort_concept.tex}
\inputif{2/document/SquareRoot_concept.tex}
\inputif{2/document/LinearSearch.tex}

\newpage
\chapter{Appendix : Used Monad Libraries}
\inputif{1/document/MonadSE.tex}
\inputif{1/document/Seq_MonadSE.tex}
\inputif{1/document/Symbex_MonadSE.tex}
\inputif{1/document/Clean_Symbex.tex}
\inputif{1/document/Test_Clean.tex}
\inputif{1/document/Hoare_MonadSE.tex}
\inputif{1/document/Hoare_Clean.tex}
