...
\input{AutoCorres_Wrapper.tex}

\input{IsPrime_linear_CCT.tex}
\input{IsPrime_linear_TCC.tex}
\input{IsPrime_sqrt_CAS.tex}
\input{IsPrime_sqrt_opt_CCT.tex}
\input{IsPrime_sqrt_opt_TCC.tex}
\input{IsPrime_sqrt_TCC.tex}

\input{Parse_for_loop.tex}
\input{Quicksort.tex}
\input{TestSEL4.tex}
