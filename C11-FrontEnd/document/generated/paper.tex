...
[label = {tit},type = {scholarly_paper.title}, args={label = {tit},type = {scholarly_paper.title}, scholarly_paper.title.short_title = {}}]Deeply Integrating C11 Code Support into Isabelle/PIDE%
\end{isamarkuptitle*}\isamarkuptrue%
%
\begin{isamarkuptext*}%
[label = {bu},type = {scholarly_paper.author}, args={label = {bu},type = {scholarly_paper.author}, scholarly_paper.author.email = {wolff@lri.fr}, scholarly_paper.author.affiliation = {LRI, Univ. Paris-Sud, CNRS, Université Paris-Saclay}, scholarly_paper.author.http_site = {https://www.lri.fr/~wolff/}, scholarly_paper.author.orcid = {}}]Burkhart Wolff%
...
%
\begin{isamarkupfigure*}%
[label = {hyplinkout},type = {Isa_COL.figure}, args={label = {hyplinkout},type = {Isa_COL.figure}, Isa_COL.figure.relative_width = {40}, Isa_COL.figure.src = {figures/markup-demo}, Isa_COL.figure.spawn_columns = {True}}]Output window showing the evaluation result of \autoref{fig:ml-pos} (clicking on the hyperlink $\protect\house$ makes the cursor jump to the \isatt{@{\char`\{}here{\char`\}}} of \autoref{fig:ml-pos})%
\end{isamarkupfigure*}\isamarkuptrue%
%
\begin{isamarkuptext}%
...
%
\begin{isamarkupsubsection*}%
[label = {navigation},type = {scholarly_paper.technical}, args={label = {navigation},type = {scholarly_paper.technical}, scholarly_paper.text_section.main_author = {@{docitem ''bu''}}, Isa_COL.text_element.level = {}, Isa_COL.text_element.referentiable = {False}, Isa_COL.text_element.variants = {{STR ''outline'', STR ''document''}}, scholarly_paper.text_section.fixme_list = {}, Isa_COL.text_element.level = {}, scholarly_paper.technical.definition_list = {}}]Navigation for Annotation Commands%
\end{isamarkupsubsection*}\isamarkuptrue%
%
\begin{isamarkuptext}%
...
above. It represents the registration of a chain of several consecutive actions.\footnote{In
  ...
  \isa{thy{\isacharunderscore}load}, \isa{thy{\isacharunderscore}defn}, etc., for example: $K_\text{\emph{cmd}} =
...
\isatagdocument
%
\isamarkupsubsection{A Gentle Zoom on Citadelle's Generator%
}
\isamarkuptrue%
%
\endisatagdocument
...
\isa{\isacommand{datatype}}, in particular to gain 10~min on the shallow-reflected
evaluation side (with the option \isa{quick{\isacharminus}and{\isacharminus}dirty} activated). This is the purpose of
the general \isa{\isacommand{Haskell{\isacharunderscore}file}} command implemented in Citadelle:~\footnote{Note that \isa{\isacommand{old{\isacharunderscore}datatype}} is a command, whereas
...
Operationally, \isa{\isacommand{Haskell{\isacharunderscore}file}} makes an implicit call to Haskabelle,
...
\isa{\isacommand{datatype}} package is not improving when being generated and executed by
...
of: \begin{quote}\emph{``How fast that specific \isa{\isacommand{datatype}}
